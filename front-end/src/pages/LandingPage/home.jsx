...
const Home = () => {
  ...
  const formattedLastLogin = isValid(lastLoginDate)
    ...
    : "Anda belum pernah login sebelumnya";
    ...
    <div className="bg-gray-100 text-gray-900 flex flex-col min-h-screen font-sans">
      ...
      <main className="flex-1 flex flex-col justify-center items-center p-4">
        <div className="bg-white p-6 md:p-8 rounded-lg shadow-lg max-w-lg w-full">
          <h2 className="text-xl md:text-2xl mb-4 font-semibold text-gray-800">
            Dashboard
          </h2>
          <p className="text-lg mb-4 text-gray-700 font-bold">Selamat datang, {fullName}!</p>
          <div className="flex gap-2">
          <p className="text-base mb-6 text-gray-600 font-bold">Terakhir Login: </p>
